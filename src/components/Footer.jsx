...
const Footer = () => {
  return (
    <footer className="border-t border-white/10 bg-black/60 backdrop-blur-xl">
      <div className="mx-auto max-w-6xl px-4 sm:px-5 py-10 space-y-3 text-white/70">
        <div className="font-extrabold tracking-[0.35em] text-white text-sm uppercase neon-title">
          IREZUMI CHILL LAB
        </div>
